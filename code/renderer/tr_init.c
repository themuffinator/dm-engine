...
//fnq
	...
	arc_crosshairs = ri.Cvar_Get( "arc_crosshairs", "1", CVAR_ARCHIVE_ND, "0", "1", CV_INTEGER );
	ri.Cvar_SetDescription( arc_crosshairs, "Aspect adjustment of crosshairs in wide screen aspect ratios." );
	arc_threewave_menu_fix = ri.Cvar_Get( "arc_threewave_menu_fix", "1", CVAR_ARCHIVE_ND, "0", "1", CV_INTEGER );
